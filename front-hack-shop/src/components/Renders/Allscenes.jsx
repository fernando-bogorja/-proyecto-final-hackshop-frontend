        ...
        <Grid item xs={7}>
          ...
          <Box sx={{ textAlign: "center" }}>
            ...
            <p>
              ...
              consequatur praesentium alias soluta dolorem amet minima nemo
              pariatur, obcaecati reprehenderit autem. Deleniti illo quisquam ea
              corporis laboriosam qui esse perferendis?
            </p>
          </Box>
        </Grid>
        <Grid item xs={6}>
